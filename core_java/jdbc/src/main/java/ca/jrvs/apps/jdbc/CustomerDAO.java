...
public class CustomerDAO extends DataAccessObject<Customer> {
    ...
    private static final String GET_ONE = "SELECT customer_id, first_name, last_name, "
            + "email, phone, phone, address, city, state, zipcode"
    ...
    private static final String GET_ALL_PAGES = "SELECT customer_id, first_name, last_name, email, phone, " +
    ...
    public Customer findById(long id) {
        ...
        try(PreparedStatement statement = this.connection.prepareStatement(GET_ONE);) {
            ...
            logger.error("Error reading statement", e);
    ...
    public List<Customer> findAllPages(int limit, int pageNumber) {
        List<Customer> customers = new ArrayList<>();
        int offSet = ((pageNumber - 1) * limit);
        try(PreparedStatement statement = this.connection.prepareStatement(GET_ALL_PAGES);){
            if(limit < 1) {
                limit=10;
            }
            statement.setInt(1, limit);
