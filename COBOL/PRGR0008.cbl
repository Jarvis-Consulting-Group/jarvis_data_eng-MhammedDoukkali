      ...
      ******************************************************************
       ...
       01  WS-WORK-AREAS.
           ...
           05 WS-DISPLAYED-TOTAL  PIC 9(4) VALUE 0.
       ...
       1100-PROCESS-RECORD.
           ...
           IF ENDOFFILE
            PERFORM 1400-STOP-PROGRAM
           ELSE
            IF WS-STUDENT-VSAM-COURSE NOT = WS-PREV-COURSE
                IF WS-PREV-COURSE NOT = SPACES
                    PERFORM 1300-DISPLAY-COURSE-FOOTER
                END-IF
                MOVE WS-STUDENT-VSAM-COURSE TO WS-PREV-COURSE
