      ...
      ******************************************************************
       ...
       1300-INVITE-AND-PROCESS.
           ...
           DISPLAY "ENTER NEW FULL NAME (MAX 25 CHARS)-SPACE TO SKIP>>".

           ACCEPT WS-INPUT-STUDENT-VSAM-NAME.

           DISPLAY "ENTER NEW BIRTHDAY (YYYYMMDD)-SPACE TO SKIP >>"
           ACCEPT WS-INPUT-STUDENT-VSAM-DOB.

           DISPLAY "ENTER NEW COURSE (MAX 15 CHARS)-SPACE TO SKIP >> ".
